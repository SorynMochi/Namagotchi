...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("/api/dev/rewind-care-decay", s.requireDev(s.requireDevUnlock(s.withDevAudit("rewind-care-decay", s.HandleRewindCareDecay))))
	mux.HandleFunc("/api/dev/spawn-wardrobe-item", s.requireDev(s.requireDevUnlock(s.withDevAudit("spawn-wardrobe-item", s.HandleSpawnDevWardrobeItem))))
